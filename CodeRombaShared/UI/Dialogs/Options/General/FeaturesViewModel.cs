...
using Mapping = WinterbiteStudios.CodeRomba.UI.Dialogs.Options.SettingToOptionMapping<bool, bool>;

namespace WinterbiteStudios.CodeRomba.UI.Dialogs.Options.General
{
    public class FeaturesViewModel : OptionsPageViewModel
    {
        public FeaturesViewModel(CodeRombaPackage package, Settings activeSettings)
