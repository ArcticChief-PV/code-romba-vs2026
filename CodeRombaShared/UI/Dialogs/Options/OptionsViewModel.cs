...
using WinterbiteStudios.CodeRomba.UI.Dialogs.Options.Collapsing;
using WinterbiteStudios.CodeRomba.UI.Dialogs.Options.Digging;
using WinterbiteStudios.CodeRomba.UI.Dialogs.Options.Finding;
using WinterbiteStudios.CodeRomba.UI.Dialogs.Options.Formatting;
using WinterbiteStudios.CodeRomba.UI.Dialogs.Options.General;
using WinterbiteStudios.CodeRomba.UI.Dialogs.Options.Progressing;
...
namespace WinterbiteStudios.CodeRomba.UI.Dialogs.Options
{
    ...
    public class OptionsViewModel : Bindable
    {
        ...
        public OptionsViewModel(CodeRombaPackage package, Type initiallySelectedPageType = null)
        {
        ...
        /// </summary>
        public CodeRombaPackage Package { get; private set; }
        ...
        private void OnExportCommandExecuted(object parameter)
        {
            ...
            {
                Title = Resources.CodeRombaExport + activeSettingsName,
                FileName = "CodeRomba",
                DefaultExt = ".config",
            ...
            if (dialog.ShowDialog() == true)
            {
                try
                {
                    ...
                    MessageBox.Show(string.Format(Resources.CodeRombaHasSuccessfullyExported + activeSettingsName + Resources.To0, dialog.FileName),
                                     Resources.CodeRombaExport + activeSettingsName + Resources.Successful, MessageBoxButton.OK, MessageBoxImage.Information);
                }
                catch (Exception ex)
                {
                    OutputWindowHelper.ExceptionWriteLine(Resources.UnableToExport + activeSettingsName, ex);
                    MessageBox.Show(Resources.CodeRombaWasUnableToExport + activeSettingsName + Resources.SeeOutputWindowForMoreDetails,
                                     Resources.CodeRombaExport + activeSettingsName + Resources.Unsuccessful, MessageBoxButton.OK, MessageBoxImage.Error);
                }
            }
        }
        ...
        private void OnImportCommandExecuted(object parameter)
        {
            ...
            {
                Title = Resources.CodeRombaImport + activeSettingsName,
                DefaultExt = ".config",
                Filter = Resources.ConfigFilesConfigConfigAllFiles,
            ...
            if (dialog.ShowDialog() == true)
            {
                try
                {
                    ...
                    MessageBox.Show(string.Format(Resources.CodeRombaHasSuccessfullyImported1From0, dialog.FileName, activeSettingsName),
                                    Resources.CodeRombaImport + activeSettingsName + Resources.Successful, MessageBoxButton.OK, MessageBoxImage.Information);
                }
                catch (Exception ex)
                {
                    OutputWindowHelper.ExceptionWriteLine(Resources._UnableToImport + activeSettingsName, ex);
                    MessageBox.Show(Resources.CodeRombaWasUnableToImport + activeSettingsName + Resources.SeeOutputWindowForMoreDetails,
                                    Resources.CodeRombaImport + activeSettingsName + Resources.Unsuccessful, MessageBoxButton.OK, MessageBoxImage.Error);
                }
            }
        }
        ...
        private void OnResetToDefaultsCommandExecuted(object parameter)
        {
            ...
            var result = MessageBox.Show(Resources.AreYouSureYouWantAll + activeSettingsName + Resources.OptionsViewModel_OnResetToDefaultsCommandExecuted_ToBeResetToTheirDefaults + Environment.NewLine + Environment.NewLine +
                                         ...
                                         Resources.CodeRombaConfirmationForReset + activeSettingsName,
            ...
            if (result == MessageBoxResult.Yes)
            {
                try
                {
                    ...
                    MessageBox.Show(string.Format(Resources.CodeRombaHasSuccessfullyReset + activeSettingsName + "."),
                                    Resources.CodeRombaReset + activeSettingsName + Resources.Successful, MessageBoxButton.OK, MessageBoxImage.Information);
                }
                catch (Exception ex)
                {
                    OutputWindowHelper.ExceptionWriteLine(Resources.UnableToReset + ActiveSettingsName, ex);
                    MessageBox.Show(Resources.CodeRombaWasUnableToReset + activeSettingsName + Resources.SeeOutputWindowForMoreDetails,
                                    Resources.CodeRombaReset + activeSettingsName + Resources.Unsuccessful, MessageBoxButton.OK, MessageBoxImage.Error);
                }
            }
        }
        ...
        private bool CheckToSavePendingChangesShouldCancelOperation()
        {
            if (HasChanges)
            {
                var result = MessageBox.Show(Resources.YouHavePendingChangesDoYouWantToSaveThemBeforeContinuing,
                    Resources.CodeRombaConfirmationToSavePendingChanges,
        ...
        /// <summary>
        /// Refreshes the default/package settings which are used throughout CodeRomba.
        /// </summary>
        /// <remarks>
