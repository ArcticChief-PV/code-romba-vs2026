...
namespace WinterbiteStudios.CodeRomba.UI.Dialogs.Options.Reorganizing
{
    /// <summary>
    ...
    public class ReorganizingRegionsViewModel : OptionsPageViewModel
    {
        ...
        public ReorganizingRegionsViewModel(CodeRombaPackage package, Settings activeSettings)
