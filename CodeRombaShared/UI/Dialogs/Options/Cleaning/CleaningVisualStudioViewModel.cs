...
namespace WinterbiteStudios.CodeRomba.UI.Dialogs.Options.Cleaning
{
    /// <summary>
    ...
    public class CleaningVisualStudioViewModel : OptionsPageViewModel
    {
        ...
        public CleaningVisualStudioViewModel(CodeRombaPackage package, Settings activeSettings)
