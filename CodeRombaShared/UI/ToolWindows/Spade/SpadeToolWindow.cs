...
using CodeModel = WinterbiteStudios.CodeRomba.Model.CodeModel;
...
namespace WinterbiteStudios.CodeRomba.UI.ToolWindows.Spade
{
    ...
    /// </summary>
    [Guid(PackageGuids.GuidCodeRombaToolWindowSpadeString)]
    public sealed class SpadeToolWindow : ToolWindowPane, IVsWindowFrameNotify3
    {
            ...
            : base(null)
        {
            ...
            Caption = Resources.CodeRombaSpade;

            // Set the tool window image from moniker.
            BitmapImageMoniker = new ImageMoniker
            {
                Guid = PackageGuids.GuidCodeRombaImageMoniker,
                Id = 2,
            };

            // Create the toolbar for the tool window.
            ToolBar = new CommandID(PackageGuids.GuidCodeRombaMenuSet, PackageIds.ToolbarIDCodeRombaToolbarSpade);
        ...
        /// </summary>
        private new CodeRombaPackage Package => base.Package as CodeRombaPackage;
        ...
        public override void ProvideSearchSettings(IVsUIDataSource pSearchSettings)
        {
            ...
            Utilities.SetValue(pSearchSettings, SearchSettingsDataSource.PropertyNames.SearchWatermark, Resources.SearchCodeRombaSpadeCtrlM);
        }
