...
namespace WinterbiteStudios.CodeRomba.Helpers
{
    ...
    internal static class TextDocumentHelper
    {
        ...
        {
            var findService = CodeRombaPackage.Instance.ComponentModel.GetService<IFindService>();
        ...
        private static bool TryGetTextBufferAt(string filePath, out ITextBuffer textBuffer)
        {
              ...
              out windowFrame))
            {
                ...
                if (view.GetBuffer(out lines) == 0)
                {
                    ...
                    if (buffer != null)
                    {
                        var editorAdapterFactoryService = CodeRombaPackage.Instance.ComponentModel.GetService<IVsEditorAdaptersFactoryService>();
