...
namespace WinterbiteStudios.CodeRomba.Helpers
{
    ...
    internal static class UIHierarchyHelper
    {
        ...
        internal static IEnumerable<UIHierarchyItem> GetSelectedUIHierarchyItems(CodeRombaPackage package)
        {
        ...
        internal static UIHierarchy GetSolutionExplorer(CodeRombaPackage package)
        {
        ...
        internal static UIHierarchyItem GetTopUIHierarchyItem(CodeRombaPackage package)
        {
            var solutionExplorer = GetSolutionExplorer(package);
