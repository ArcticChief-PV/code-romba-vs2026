...
namespace WinterbiteStudios.CodeRomba.Helpers
{
    ...
    internal static class SolutionHelper
    {
        ...
        internal static IEnumerable<ProjectItem> GetSelectedProjectItemsRecursively(CodeRombaPackage package)
        {
        ...
        internal static IEnumerable<ProjectItem> GetSimilarProjectItems(CodeRombaPackage package, ProjectItem projectItem)
        {
