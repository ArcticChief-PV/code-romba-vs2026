...
namespace WinterbiteStudios.CodeRomba.Helpers
{
    ...
    {
        private const string SettingsFilename = "CodeRomba.config";
        ...
        private SettingsContextHelper(CodeRombaPackage package)
        {
            _package = package;
        }
        ...
        internal static SettingsContextHelper GetInstance(CodeRombaPackage package)
        {
        ...
        {
            return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "CodeRomba", SettingsFilename);
        }
