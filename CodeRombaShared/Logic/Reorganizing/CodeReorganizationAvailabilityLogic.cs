...
namespace WinterbiteStudios.CodeRomba.Logic.Reorganizing
{
    ...
    internal class CodeReorganizationAvailabilityLogic
    {
        ...
        internal static CodeReorganizationAvailabilityLogic GetInstance(CodeRombaPackage package)
        {
        ...
        /// </summary>
        /// <param name="package">The hosting package.</param>
        private CodeReorganizationAvailabilityLogic(CodeRombaPackage package)
        {
            _package = package;
        }
        ...
        private static bool PromptUserAboutReorganizingPreprocessorConditionals(Document document)
        {
            try
            {
                ...
                {
                    Title = @Resources.CodeRombaReorganizePreprocessorConditionals,
