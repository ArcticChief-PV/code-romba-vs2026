...
namespace WinterbiteStudios.CodeRomba.Logic.Reorganizing
{
    ...
    internal class CodeReorganizationManager
    {
        ...
        internal static CodeReorganizationManager GetInstance(CodeRombaPackage package)
        {
        ...
        /// </summary>
        /// <param name="package">The hosting package.</param>
        private CodeReorganizationManager(CodeRombaPackage package)
        {
            _package = package;
        ...
        {
            new UndoTransactionHelper(_package, Resources.CodeRombaMoveItemAbove).Run(
        ...
        {
            new UndoTransactionHelper(_package, Resources.CodeRombaMoveItemBelow).Run(
        ...
        {
            new UndoTransactionHelper(_package, Resources.CodeRombaMoveItemInto).Run(
        ...
        internal void Reorganize(Document document)
        {
            ...
            new UndoTransactionHelper(_package, string.Format(Resources.CodeRombaReorganizeFor0, document.Name)).Run(
                delegate
                {
                    OutputWindowHelper.DiagnosticWriteLine($"CodeReorganizationManager.Reorganize started for '{document.FullName}'");
                    _package.IDE.StatusBar.Text = string.Format(Resources.Reorganize_CodeRombaIsReorganizing0, document.Name);
                    ...
                    _package.IDE.StatusBar.Text = string.Format(Resources.CodeRombaReorganized0, document.Name);
