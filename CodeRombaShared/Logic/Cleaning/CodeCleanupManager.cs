...
namespace WinterbiteStudios.CodeRomba.Logic.Cleaning
{
    ...
    internal class CodeCleanupManager
    {
        ...
        internal static CodeCleanupManager GetInstance(CodeRombaPackage package)
        {
        ...
        /// </summary>
        /// <param name="package">The hosting package.</param>
        private CodeCleanupManager(CodeRombaPackage package)
        {
            _package = package;
        ...
        internal void Cleanup(Document document)
        {
            ...
            new UndoTransactionHelper(_package, string.Format(Resources.CodeRombaCleanupFor0, document.Name)).Run(
                delegate
                {
                    ...
                    if (cleanupMethod != null)
                    {
                        ...
                        _package.IDE.StatusBar.Text = string.Format(Resources.CodeRombaIsCleaning0, document.Name);

                        // Perform the set of configured cleanups based on the language.
                        cleanupMethod(document);

                        _package.IDE.StatusBar.Text = string.Format(Resources.CodeRombaCleaned0, document.Name);
