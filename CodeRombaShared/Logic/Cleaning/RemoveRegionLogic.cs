...
namespace WinterbiteStudios.CodeRomba.Logic.Cleaning
{
    ...
    internal class RemoveRegionLogic
    {
        ...
        internal static RemoveRegionLogic GetInstance(CodeRombaPackage package)
        {
        ...
        /// </summary>
        /// <param name="package">The hosting package.</param>
        private RemoveRegionLogic(CodeRombaPackage package)
        {
            _package = package;
        ...
        internal void RemoveRegions(TextDocument textDocument)
        {
            ...
            new UndoTransactionHelper(_package, Resources.CodeRombaRemoveAllRegions).Run(() =>
            {
        ...
        internal void RemoveRegions(TextSelection textSelection)
        {
            ...
            new UndoTransactionHelper(_package, Resources.CodeRombaRemoveSelectedRegions).Run(() =>
            {
                foreach (var region in regions)
                {
                    RemoveRegion(region);
        ...
        {
            new UndoTransactionHelper(_package, Resources.CodeRombaRemoveRegions).Run(() =>
            {
        ...
        internal void RemoveRegion(CodeItemRegion region)
        {
            ...
            new UndoTransactionHelper(_package, Resources.CodeRombaRemoveRegion + region.Name).Run(() =>
            {
