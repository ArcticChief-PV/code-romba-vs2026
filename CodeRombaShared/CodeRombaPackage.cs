...
using WinterbiteStudios.CodeRomba.Integration.Commands;
using WinterbiteStudios.CodeRomba.Integration.Events;
using WinterbiteStudios.CodeRomba.Model;
using WinterbiteStudios.CodeRomba.Properties;
using WinterbiteStudios.CodeRomba.UI;
using WinterbiteStudios.CodeRomba.UI.ToolWindows.BuildProgress;
using WinterbiteStudios.CodeRomba.UI.ToolWindows.Spade;
using System;
...
namespace WinterbiteStudios.CodeRomba
{
    ...
    [InstalledProductRegistration("#110", "#112", Vsix.Version, IconResourceID = 400, LanguageIndependentName = "CodeRomba")] // VS Help/About details (Name, Description, Version, Icon).
    [ProvideAutoLoad(VSConstants.UICONTEXT.SolutionExistsAndFullyLoaded_string, PackageAutoLoadFlags.BackgroundLoad)] // Trigger CodeRomba to load on solution open so menu items can determine their state.
    [ProvideBindingPath]
    ...
    [Guid(PackageGuids.GuidCodeRombaPackageString)] // Package unique GUID.
    public sealed class CodeRombaPackage : AsyncPackage
    {
        /// <summary>
        ...
        /// </summary>
        internal static CodeRombaPackage Instance;

        /// <summary>
        /// Initializes a new instance of the <see cref="CodeRombaPackage"/> class.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Gets or sets a flag indicating if CodeRomba is running inside an AutoSave context.
        /// </summary>
        ...
        private async Task RegisterEventListenersAsync()
        {
            ...
            // Check if a solution has already been opened before CodeRomba was initialized.
