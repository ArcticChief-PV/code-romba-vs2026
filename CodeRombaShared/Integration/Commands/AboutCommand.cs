...
{
    /// <summary>
    /// A command that provides for launching the CodeRomba about window.
    /// </summary>
    internal sealed class AboutCommand : BaseCommand
    {
        ...
        private AboutCommand(CodeRombaPackage package)
            : base(package, PackageGuids.GuidCodeRombaMenuSet, PackageIds.CmdIDCodeRombaAbout)
        {
        }
