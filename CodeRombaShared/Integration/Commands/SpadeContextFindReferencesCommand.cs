...
namespace WinterbiteStudios.CodeRomba.Integration.Commands
{
    ...
    internal sealed class SpadeContextFindReferencesCommand : BaseCommand
    {
        ...
        internal SpadeContextFindReferencesCommand(CodeRombaPackage package)
            : base(package, PackageGuids.GuidCodeRombaMenuSet, PackageIds.CmdIDCodeRombaSpadeContextFindReferences)
        {
        }
