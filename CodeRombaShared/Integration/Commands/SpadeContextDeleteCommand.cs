...
namespace WinterbiteStudios.CodeRomba.Integration.Commands
{
    ...
    internal sealed class SpadeContextDeleteCommand : BaseCommand
    {
        ...
        internal SpadeContextDeleteCommand(CodeRombaPackage package)
            : base(package, PackageGuids.GuidCodeRombaMenuSet, PackageIds.CmdIDCodeRombaSpadeContextDelete)
        {
            _undoTransactionHelper = new UndoTransactionHelper(package, Resources.CodeRombaDeleteItems);
        }
