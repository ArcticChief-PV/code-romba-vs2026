...
namespace WinterbiteStudios.CodeRomba.Integration.Commands
{
    ...
    internal sealed class SettingCleanupOnSaveCommand : BaseCommand
    {
        ...
        internal SettingCleanupOnSaveCommand(CodeRombaPackage package)
            : base(package, PackageGuids.GuidCodeRombaMenuSet, PackageIds.CmdIDCodeRombaSettingCleanupOnSave)
        {
        }
        ...
        protected override void OnExecute()
        {
            ...
            Package.IDE.StatusBar.Text = $"{Resources.CodeRombaTurnedAutomaticCleanupOnSave} {CleanupOnSaveStateText}.";
        }
    }
}