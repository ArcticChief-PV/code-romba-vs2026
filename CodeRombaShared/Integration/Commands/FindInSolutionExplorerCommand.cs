...
namespace WinterbiteStudios.CodeRomba.Integration.Commands
{
    ...
    internal sealed class FindInSolutionExplorerCommand : BaseCommand
    {
        ...
        internal FindInSolutionExplorerCommand(CodeRombaPackage package)
            : base(package, PackageGuids.GuidCodeRombaMenuSet, PackageIds.CmdIDCodeRombaFindInSolutionExplorer)
        {
