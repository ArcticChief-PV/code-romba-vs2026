...
namespace WinterbiteStudios.CodeRomba.Integration.Commands
{
    ...
    internal sealed class BuildProgressToolWindowCommand : BaseCommand
    {
        ...
        internal BuildProgressToolWindowCommand(CodeRombaPackage package)
            : base(package, PackageGuids.GuidCodeRombaMenuSet, PackageIds.CmdIDCodeRombaBuildProgressToolWindow)
        {
        }
