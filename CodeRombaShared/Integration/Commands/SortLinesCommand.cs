...
namespace WinterbiteStudios.CodeRomba.Integration.Commands
{
    ...
    internal sealed class SortLinesCommand : BaseCommand
    {
        ...
        internal SortLinesCommand(CodeRombaPackage package)
            : base(package, PackageGuids.GuidCodeRombaMenuSet, PackageIds.CmdIDCodeRombaSortLines)
        {
            _undoTransactionHelper = new UndoTransactionHelper(package, Resources.CodeRombaSort);
        }
