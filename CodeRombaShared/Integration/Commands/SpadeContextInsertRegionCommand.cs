...
namespace WinterbiteStudios.CodeRomba.Integration.Commands
{
    ...
    internal sealed class SpadeContextInsertRegionCommand : BaseCommand
    {
        ...
        internal SpadeContextInsertRegionCommand(CodeRombaPackage package)
            : base(package, PackageGuids.GuidCodeRombaMenuSet, PackageIds.CmdIDCodeRombaSpadeContextInsertRegion)
        {
            _generateRegionLogic = GenerateRegionLogic.GetInstance(package);
            _undoTransactionHelper = new UndoTransactionHelper(package, Resources.CodeRombaInsertRegion);
        }
