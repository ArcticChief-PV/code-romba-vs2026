...
namespace WinterbiteStudios.CodeRomba.Integration.Commands
{
    ...
    internal sealed class SpadeSortOrderAlphaCommand : BaseCommand
    {
        ...
        internal SpadeSortOrderAlphaCommand(CodeRombaPackage package)
            : base(package, PackageGuids.GuidCodeRombaMenuSet, PackageIds.CmdIDCodeRombaSpadeSortOrderAlpha)
        {
        }
