...
namespace WinterbiteStudios.CodeRomba.Integration.Commands
{
    ...
    internal sealed class ReorganizeActiveCodeCommand : BaseCommand
    {
        ...
        internal ReorganizeActiveCodeCommand(CodeRombaPackage package)
            : base(package, PackageGuids.GuidCodeRombaMenuSet, PackageIds.CmdIDCodeRombaReorganizeActiveCode)
        {
