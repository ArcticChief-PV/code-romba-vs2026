...
namespace WinterbiteStudios.CodeRomba.Integration.Commands
{
    ...
    internal sealed class SpadeContextRemoveRegionCommand : BaseCommand
    {
        ...
        internal SpadeContextRemoveRegionCommand(CodeRombaPackage package)
            : base(package, PackageGuids.GuidCodeRombaMenuSet, PackageIds.CmdIDCodeRombaSpadeContextRemoveRegion)
        {
